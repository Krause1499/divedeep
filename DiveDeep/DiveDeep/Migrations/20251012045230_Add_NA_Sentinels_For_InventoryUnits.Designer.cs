...
namespace DiveDeep.Migrations
{
    ...
    [Migration("20251012045230_Add_NA_Sentinels_For_InventoryUnits")]
    partial class Add_NA_Sentinels_For_InventoryUnits
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiveDeep.Models.InventoryUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductId", "Size", "Gender")
                        .IsUnique();
            ...
            modelBuilder.Entity("DiveDeep.Models.OrderItem", b =>
                {
                    b.HasOne("DiveDeep.Models.InventoryUnit", "InventoryUnit")
                        .WithMany()
