...
namespace DiveDeep.Persistence
{
    public static class ProductRepository
    {
        public static List<Category> Products = new List<Category>
        {
            ...
            new Fin {Id = 16, ProductType = ProductType.Fin, Brand = "Scubapro", Model = "Jet Fin", Price = 50,
                     FilePath = "https://aquashoppen.dk/files/products/S-25365400.jpg"},
            new Fin {Id = 17, ProductType = ProductType.Fin, Brand = "Scubapro", Model = "GO Travel", Price = 50,
            ...
            new Fin {Id = 18, ProductType = ProductType.Fin, Brand = "Scubapro", Model = "Seawing Supernova", Price = 60,
                     FilePath = "https://shop11921.sfstatic.io/upload_dir/shop/SP_25505X00_Seawing_Supernova_2.jpg"},
            new Fin {Id = 19, ProductType = ProductType.Fin, Brand = "Seac", Model = "Propulsion", Price = 50,
                     FilePath = "https://shop11921.sfstatic.io/upload_dir/shop/seac-finne-propulsion-s-hvid-1.jpg"},
            new Fin {Id = 20, ProductType = ProductType.Fin, Brand = "Seac", Model = "ALA", Price = 50,
                     FilePath = "https://www.kids-world.dk/images/YP436.jpg"},
            new Fin {Id = 21, ProductType = ProductType.Fin, Brand = "Fourth Element", Model="Tech", Price = 75,
                     FilePath = "https://www.onlinedivegear.com.au/cdn/shop/products/Fourth-Element-Tech-Fins-Grey_500x.jpg?v=1655305970"},
            new Fin {Id = 22, ProductType = ProductType.Fin, Brand = "Fourth Element", Model = "Rec Fin", Price = 80,
